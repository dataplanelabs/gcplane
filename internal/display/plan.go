...
// output is the writer for all display functions. Tests override this to capture output.
var output io.Writer = os.Stdout

// p writes formatted output, discarding write errors (terminal output is best-effort).
...
func PrintDiff(plan *reconciler.Plan) {
	...
	if !hasDrift {
		p("%s\n","No drift detected. All resources in sync.")
		return
	}
